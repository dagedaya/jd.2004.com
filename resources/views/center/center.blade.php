                ...
                <div class="yui3-g Logo">
                    ...
                    <div class="yui3-u Right shopArea">
                        <div class="fr shopcar">
                            ...
                            <br>
                            <br>
{{--                            <span class="line-item btn-favorite " id="btn-sign">--}}
{{--                                <img src="/static/img/收藏添加.jpg" width="20px" height="20px" alt="收藏logo" srcset="">签到--}}
{{--                                </span>--}}

{{--                            <button class="sui-btn btn-default btn-xlarge" id="btn1" style="width:66px;height: 40px;display:none;">已签到</button>--}}
                        </div>
                    </div>
                </div>
...
<button class="sui-btn btn-info share-btn" id="btn-sign" type="button" style="width:66px;height: 40px;margin-left:180px;margin-top:10px;">签到</button>
