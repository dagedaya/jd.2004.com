					...
					<ul class="fl">
						...
						<li class="f-item">
                            @if(empty(session('user_id')))
                                请<a href="{{url('/login/login')}}" target="_blank">登录</a>
                                <span><a href="/login/register" target="_blank">免费注册</a></span>
                            @else
                                &nbsp;&nbsp;<span>欢迎<a href=""><a style="color:red;">{{session('user_name')}}</a>登陆</a></span>&nbsp;
                                &nbsp;<span><a href="{{url('login/exit')}}">退出</a></span></li>
                        @endif
					</ul>
					<ul class="fr">
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
                                        <button target="_blank" class="sui-btn btn-danger addshopcar" id="cart">加入购物车</button>
									</li>
								</ul>
							</div>
						</div>
